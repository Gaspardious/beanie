...
const Reviews = ({customerName, text, customerNumber, heading }: ReviewProps) => {
  return (
    <div className="my-5 sm:my-10">
        <p className="text-xs font-bold text-white bg-black/90 border w-fit py-1 px-3 rounded-tr-2xl">{customerNumber}</p>
            <div className="flex flex-wrap justify-center text-black bg-white p-5 w-fit rounded-r-full ">
                <section>
                    ...
                    <p className=" bg-black/90 text-white w-fit py-1 px-2 rounded-lg">{customerName}</p>
                </section>
            </div>
    </div>
  )
