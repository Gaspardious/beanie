...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      ...
      <Info BigText="The Classic Beanie" SmallText="The classic beanie is a timeless and classic accessory that never goes out of style." paddingImage="p-1" ImageSrc="/beanie_black.jpg" BtnText="Beanies →"/>
      <Info BigText="The Golden Beanie" SmallText="Bold and chic, the golden beanie is the perfect accessory for any occasion." BtnText="Beanies →" ImageSrc="/beanie_gold.png" paddingImage="p-10" reverse/>
