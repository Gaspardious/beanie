        ...
        <form className='mt-[200px] md:mt-[100px]' action="">
          <div className="flex flex-col items-center justify-center h-full gap-10">
            ...
            <div className="flex flex-col items-center justify-center h-full gap-10">
              ...
              <input required type="text" placeholder="Ämne*" className="w-80 h-10 text-black  bg-white placeholder:text-black border-2 border-black rounded pl-2"/>
              <textarea required minLength={50} name="message" id="message" cols={30} rows={10} placeholder="Meddelande*" className="w-80 h-40 text-black   bg-white placeholder:text-black border-2 border-black rounded pl-2"></textarea>
              <button className="bg-[#0f0f0f] hover:bg-[#3a3a3a] cursor-pointer text-white font-bold py-2 px-4 rounded w-31">Skicka</button>
            </div>
          </div>
